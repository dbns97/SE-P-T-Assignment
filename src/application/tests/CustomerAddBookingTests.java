...
import application.controllers.CustomerMakeBookingController;
...
public class CustomerAddBookingTests {
	...
	public void checkBookingTests() {
		...
		CustomerMakeBookingController controller = new CustomerMakeBookingController();
		String result = controller.checkBooking("Service Name", "Name", today.toUpperCase(), time, business);
